...
const MyClients = () => {
    ...
    const openEditModal = (client) => {
        ...
        setFormData({
            ...
            city: client.city || '',
            country: client.country || 'Zimbabwe',
            tin: client.tin || '',
                                        ...
                                        <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                            ...
                                            {modalMode === 'merge' ? (
                                                ...
                                                <div className="space-y-5 max-h-[70vh] overflow-y-auto pr-1">
                                                    {/* Identity */}
                                                    <div>
                                                        <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Client Identity</h4>
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                            <div>
                                                                <label className="block text-sm font-medium text-gray-700">Client / Contact Name <span className="text-red-500">*</span></label>
                                                                <input
                                                                    type="text"
                                                                    required
                                                                    minLength={2}
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="space-y-3">
                                                            <input
                                                                type="text"
                                                                placeholder="Address line 1 (e.g. Office 4, Karimapondo Building)"
                                                            ...
                                                            <input
                                                                type="text"
                                                                placeholder="Address line 2 (e.g. 78 Leopold Takawira)"
                                                                className="block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm"
                                                    ...
                                                    {/* Tax */}
                                                    <div>
                                                        <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Tax Information</h4>
                                                        <p className="text-xs text-gray-500 mb-3">Required for business clients. Will appear on invoices.</p>
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                            <div>
                                                                <label className="block text-sm font-medium text-gray-700">TIN</label>
                                                                <input
                                                                    type="text"
                                                                    placeholder="10-digit ZIMRA TIN"
                                                                    className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-red-500 focus:border-red-500 sm:text-sm"
                                                                    value={formData.tin}
